...
import static Entidades.AESUtils.encriptarObjeto;
...
public class TicketGrantingServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Client.ClientAuthentication autenticacionCliente = TGS.getAutificacionCliente();// Autentificacion del cliente
                                                                                        // de la peticion
        ...
        boolean coinciden = // verifica que los datos del ticket coincidan con los datos del ticket
                autenticacionCliente.getIp_cliente().equals(ticket_tgs.getIp_cliente())
    ...
    public void recibirPeticionTicketDesdeCliente(InputStream inputStream) throws Exception {
        ...
        HashMap<String, Object> peticion = (HashMap<String, Object>) Comunicaciones.recibirObjeto(inputStream); // recibe
                                                                                                                // la
                                                                                                                // peticion
                                                                                                                // desde
                                                                                                                // el
        ...
        Client.ClientAuthentication autenticacionCliente = (Client.ClientAuthentication) AESUtils
                .desencriptarObjeto((SealedObject) peticion.get("[Autentificador-c]"), "contraseña_C-TGS"); // descifra
                                                                                                            // el objeto
                                                                                                            // autenticacion
        ...
        AuthenticationServer.Ticket_TGS ticket_tgs = (AuthenticationServer.Ticket_TGS) AESUtils
                .desencriptarObjeto((SealedObject) peticion.get("[Ticket-tgs]"), "contraseñaTGS"); // descifra el ticket
                                                                                                   // recibido
    ...
    public void enviarRespuestaTicketAlCliente(OutputStream outputStream) throws Exception {
        HashMap<String, Object> respuestaTicket = this.crearRespuestaTicket(); // crea la respuesta a la peticion del
                                                                               // cliente
        SealedObject respuestaCifrada = encriptarObjeto(respuestaTicket,
                ticket_tgs.getClave_Cliente_TicketGrantingServer()); // Cifra la respuesta con la Contraseña entre el
                                                                     // cliente y el TGS
        Comunicaciones.enviarObjeto(outputStream, respuestaCifrada); // Envia el mensaje concatenado al cliente
                                                                     // conteniendo el Ticket-v
        System.out.printf("\nRespuesta sin cifrar: %s", respuestaTicket);
        System.out.printf("\nRespuesta cifrada a enviar: %s", respuestaCifrada);
    }
    //
    // public void setClave_cliente_ticketGrantingServer(Key
    // clave_cliente_ticketGrantingServer) {
    ...
    public HashMap<String, Object> crearRespuestaTicket() throws Exception {
        ...
        respuestaSolicitud.put("[K-c_v]", ticket_servidor.getClave_cliente_servidor()); // una clave entre el Cliente y
                                                                                        // el Servidor (K c-v)
        ...
        SealedObject ticket_servidor_cifrado = encriptarObjeto(ticket_servidor, "contraseñaServidor"); // cifrar
                                                                                                       // ticket-v con
                                                                                                       // la contraseña
                                                                                                       // del servidor
