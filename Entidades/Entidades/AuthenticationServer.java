...
public class AuthenticationServer {
    ...
    public void recibirSolicitudTGTdesdeCliente(Socket conexionCliente) throws Exception {
        HashMap<String, Object> solicitudTGT = (HashMap<String, Object>) Comunicaciones
                .recibirObjeto(conexionCliente.getInputStream()); // recibe la solicitud de intercambio desde el TGT
    ...
    public void responderSolicitudTGTalCliente(OutputStream outputStream) throws Exception {
        HashMap<String, Object> respuestaSolicitud = this.getRespuestaSolicitudTicket_TGS();// crea la respuesta a la
                                                                                            // solicitud del cliente
        SealedObject respuestaCifrada = encriptarObjeto(respuestaSolicitud, BDD_usuarios.get(this.id_cliente)); // crea
                                                                                                                // y
                                                                                                                // Cifra
                                                                                                                // la
                                                                                                                // respuesta
    ...
    /**
     * Obtiene un mensaje que contiene entre otras cosas el ticket TGS solicitado
     * por el cliente
     *
    ...
    HashMap<String, Object> getRespuestaSolicitudTicket_TGS() throws Exception {
        ...
        Ticket_TGS ticket_tgs = new Ticket_TGS(clave_Cliente_TicketGrantingServer, id_cliente, address_cliente,
                id_TicketGrantingServer, 5); // crea el ticketTGS
        ...
        SealedObject ticket_tgs_cifrado = encriptarObjeto(ticket_tgs, clave_TicketGrantingServer); // cifrar ticket con
                                                                                                   // clave TGS
