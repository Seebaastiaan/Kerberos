...
public class Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Socket conexionServiceServer = Conexiones.obtenerConexion(puertoServiceServer, ipServiceServer); // conectarse
                                                                                                         // con TGS
    ...
    public void recibirTGTdesdeAS(InputStream inputStream) throws Exception {
        ...
        SealedObject respuetaCifrada = (SealedObject) Comunicaciones.recibirObjeto(inputStream); // recibe la respuesta
                                                                                                 // cifrada del AS
        HashMap<String, Object> respuestaDescifrada = (HashMap<String, Object>) AESUtils
                .desencriptarObjeto(respuetaCifrada, "ContraseniaCliente"); // desencripta la respuesta del as
        System.out.printf("Repuestas recibida desde el AS: %s \n\n", respuestaDescifrada);

        this.setClave_Cliente_TicketGrantingServer((String) respuestaDescifrada.get("[K-c_tgs]")); // obtiene la clave
                                                                                                   // entre el cliente y
                                                                                                   // el TGS
    ...
    public void realizarPeticionTickethaciaTGS(OutputStream outputStream) throws Exception {
        HashMap<String, Object> solicitudIntercambioTGS = this.generarSolicitudIntercambioTGS(); // crea la solicitud de
                                                                                                 // intercambio de
                                                                                                 // Tickets hacia el TGS
    ...
    public void recibirTicketdesdeTGS(InputStream inputStream) throws Exception {
        SealedObject respuestaCifrada = (SealedObject) Comunicaciones.recibirObjeto(inputStream); // recibe la respuesa
                                                                                                  // cifrada desde el
                                                                                                  // TGT
        HashMap<String, Object> respuesta = (HashMap<String, Object>) AESUtils.desencriptarObjeto(respuestaCifrada,
                this.getClave_Cliente_TicketGrantingServer()); // descifra el mensaje recibido con la clave entre el
                                                               // cliente y el TGS (K c-tgs)
        System.out.printf("Repuestas recibida: %s \n\n", respuesta);

        this.setTicket_servicio((SealedObject) respuesta.get("[Ticket-v]"));// obtiene el Ticket para el Servidor
                                                                            // Cifrado
        this.setClave_cliente_servidor((String) respuesta.get("[K-c_v]"));// obtiene la clave entre el cliente y el
                                                                          // servidor
    }

    public void realizarPeticionServiciohaciaServidor(OutputStream outputStream) throws Exception {
        HashMap<String, Object> peticionServicio = this.generarSolicitudIntercambioServicio(); // crea la solicitud de
                                                                                               // intercambio de
                                                                                               // servicio que se
                                                                                               // enviara al Servidor
    ...
    public void recibirServiciodesdeServidor(InputStream inputStream) throws Exception {
        SealedObject respuestaCifrada = (SealedObject) Comunicacion.recibirObjeto(inputStream); // recibe la respuesta
                                                                                                // desde el servidor
        ...
        HashMap<String, Object> respuestaServicio = (HashMap<String, Object>) AESUtils
                .desencriptarObjeto(respuestaCifrada, this.getClave_cliente_servidor()); // descifra la respuesta con la
                                                                                         // clave entre el cliente y el
                                                                                         // servidor
