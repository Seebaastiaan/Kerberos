...
public class ServiceServer {
    ...
    public final String servicio = "sss";
    ...
    public static void main(String[] args) throws Exception {
        ...
        serviceServer.setClave_servidor("contraseñaServidor"); // constraseña propia del servidor previamente
                                                               // distribuida la cual fue creada por el TGT
        ...
        serviceServer.recibirPeticionServicioDesdeCliente(inputStream);// recibe la peticion de Intercambio de servicio
                                                                       // desde el cliente [paso 5] Kerberos

        TicketGrantingServer.Ticket_servicio ticket_servicio = serviceServer.getTicketServicio(); // descifrado de la
                                                                                                  // peticion
        Client.ClientAuthentication clientAuthentication = serviceServer.getClientAuthentication(); // Autentificacion
                                                                                                    // del cliente
                                                                                                    // descifrada
        boolean esClienteValido = serviceServer.validarClienteConTicket(ticket_servicio, clientAuthentication);// valida
                                                                                                               // al
                                                                                                               // cliente
                                                                                                               // comparando
                                                                                                               // sus
        ...
        serviceServer.responderPeticionServicioCliente(outputStream); // envia intercambio de servicion al cliente [paso
                                                                      // 6] Kerberos
    ...
    public void recibirPeticionServicioDesdeCliente(InputStream inputStream) throws Exception {
        ...
        HashMap<String, Object> peticionServicio = (HashMap<String, Object>) Comunicaciones.recibirObjeto(inputStream); // recibe
                                                                                                                        // la
                                                                                                                        // peticion
                                                                                                                        // del
                                                                                                                        // servicio
        ...
        SealedObject ticketServicio_cifrado = (SealedObject) peticionServicio.get("[Ticket-v]"); // obtiene el ticket
                                                                                                 // cifrado desde la
                                                                                                 // peticion del cliente
        TicketGrantingServer.Ticket_servicio ticket_servicio = (TicketGrantingServer.Ticket_servicio) AESUtils
                .desencriptarObjeto(ticketServicio_cifrado, this.getClave_servidor()); // descifra el ticket con su
                                                                                       // clave servidor (K-v)
        ...
        ; // obtiene la contraseña entre el cliente y el servidor del ticket que se
          // descifro

        SealedObject autentificadorCliente_cifrado = (SealedObject) peticionServicio.get("[Autentificador-c]"); // obtiene
                                                                                                                // el
                                                                                                                // autentificador
                                                                                                                // cifrado
                                                                                                                // del
        ...
        Client.ClientAuthentication autentificadorCliente = (Client.ClientAuthentication) AESUtils
                .desencriptarObjeto(autentificadorCliente_cifrado, this.getClave_cliente_servidor()); // descifra el
                                                                                                      // autentificador
                                                                                                      // del cliente con
                                                                                                      // la clave entre
                                                                                                      // el cliente y el
        ...
        this.setTimestamp5(autentificadorCliente.getTimeStamp_ClientAuthentication()); // guarda el TimeStamp del
                                                                                       // autentificador del cliente
    ...
    public void responderPeticionServicioCliente(OutputStream outputStream) throws Exception {
        HashMap<String, Object> respuestaServicio = this.responderServicio(); // crea el mensaje de respuesta del
                                                                              // servicio para el cliente
        SealedObject respuestaServicio_cifrada = AESUtils.encriptarObjeto(respuestaServicio,
                this.getClave_cliente_servidor()); // cifra la respuesta del servicio con la clave entre el cliente y el
                                                   // servidor (K_c-v)
        Comunicaciones.enviarObjeto(outputStream, respuestaServicio_cifrada); // envia de vuelta al cliente la respuesta
                                                                              // cifrada
    ...
    public HashMap<String, Object> responderServicio() throws Exception {
        ...
        respuestaSolicitud.put("[TimeStamp-incrementada]", timestamp5.plusMinutes(1)); // añade el timeStamp del
                                                                                       // autentificador-cliente
                                                                                       // incrementado en un minuto
    ...
    private boolean validarClienteConTicket(TicketGrantingServer.Ticket_servicio ticket_servicio,
        ...
        esClienteValido = (ticket_servicio.getId_cliente().equals(autentificadorCliente.getId_cliente())) // compara el
                                                                                                          // id del
                                                                                                          // ticket con
                                                                                                          // el del
                                                                                                          // autentificador
                && (ticket_servicio.getIp_cliente().equals(autentificadorCliente.getIp_cliente()))// compara la ip
                                                                                                  // especificada en el
                                                                                                  // ticket con la ip
                                                                                                  // del autentificador
                && ticket_servicio.getTiempo_vida_ticket().isAfter(LocalDateTime.now());// Verifica si el tiempo de vida
                                                                                        // del ticket aun no ha pasado
